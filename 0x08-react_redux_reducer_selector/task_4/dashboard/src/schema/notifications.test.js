...
describe("Test for Notifications.js", () => {
  it("verify that the function returns the correct data", () => {
    ...
    expect(context).toEqual(expect.arrayContaining(data));
  });
});

describe("Test for Normalized Notifications", () => {
  test("Verify that normalized data has the correct result array", () => {
  ...
  test("Verify that normalized data has a correct messages entity", () => {
    const expectedResult = {
  ...
  test("Verify that normalized data has a correct notifications entity", () => {
    const expectedResult = {
